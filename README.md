...
__* 假设字符3750，字符900和字符648是句子的标点符号，请分析赛题每篇新闻平均由多少个句子构成？__
...
* 本题的难点主要是 __对应新闻类别对应字符合并一个字符串__ ，并且要知道 __text集__ 中包含的元素为 __字符串__ ,以及 __如何生成定长的非空以字符串、数字为内部元素的列表__  
* 本题解答过程中的非空定长字符串列表是我手动构建的，还需要多学习摸索，探索能自动生成定长的不同类型的列表的方法
...
__* 基于控制变量法，通过增大训练集，来观察最终训练模型的预测精度变化__
...
__分析总结：__   
* 很明显，将训练的数据集由 __10000__ 增大到 __15000__ ，有利于提高了模型的精度  
* 还是需要自己多学习机器学习的 __基础知识和相关常用模型框架__
----------------------------------------------  
__* 题目二：__   
